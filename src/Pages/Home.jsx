...
import sideImg from "../Assets/img/WebDev.svg";
...
const Home = () => {
  return (
    <main className="relative pt-24">
      <div className="py-4 sm:px-4 dark:bg-primary-dark">
        <div className="items-center max-w-none grid grid-cols-1 md:grid-cols-2 gap-x-1 px-6 py-5 mx-auto">
          <div className="py-4 lg:max-w-3xl md:max-w-2xl sm:text-center md:text-left ">
            <h1
              className=" font-sans text-center text-3xl md:text-5xl lg:text-7xl
                mb-4 leading-tight font-medium tracking-normal text-black
                md:text-left sm:text-4xl dark:text-[#FFF2AD]"
            >
              SMART IDEAS YOU ARE LOOKING FOR HERE
            </h1>
            <p
              className="block antialiased font-sans text-xl 
            font-normal mb-6 text-center md:text-left text-black dark:text-[#FFF2AD]"
            >
              Our Customers demand by making them Satisfied with growing their
              busines
            </p>
            <div className="flex flex-col items-center justify-center md:justify-start gap-2 sm:flex-row ">
              <a href="/">
                <button
                  className="middle none font-sans font-bold center uppercase transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none 
              ...
              <button className="flex rounded-lg border border-gray-100 bg-white/80 sm:w-2/2 sm:h-2/2 py-2.5 px-5 text-[#1A237E] shadow-2xl shadow-blue-gray-500/20 backdrop-blur-2xl backdrop-saturate-200">
                <AiOutlinePlayCircle className="text-xl font-semibold  " />{" "}
                <a
                  href="https://fb.watch/eLFYxoCiFK/"
          ...
          <div className="flex items-center justify-center py-4 lg:w-1/1 max-w-none sm:max-w-2xl lg:max-w-3xl">
            <img
              src={sideImg}
              className="object-cover w-full mx-auto max-w-xl py-4"
              alt=""
            />
          </div>
        </div>
        ...
        <div className="container z-20 mx-auto px-2 ">
          <section className="py-6 lg:py-20 sm:space-y-12 ">
            ...
            <div className="mx-auto mb-4 sm:mb-2 w-full text-center md:w-3/4 lg:w-1/2">
              <div
                className="block antialiased font-sans text-4xl leading-[1.3] mb-2 font-bold tracking-normal bg-clip-text text-transparent 
            ...
            <section className="pt-2 pl-4 sm:items-center sm:justify-center sm:px-0 ">
              <div className="flex flex-wrap  items-center px-0 sm:px-2">
                <div className="w-full   lg:w-5/12 sm:items-center sm:px-2 sm:text-center">
                  <h1
                    className="justify-center font-sans font-bold mb-2 text-2xl text-center bg-clip-text text-transparent 
                  bg-gradient-to-tr from-blue-600 to-blue-400 md:pr-10 "
                  >
                    {" "}
                    The Meta Apps
                  </h1>
                  <p className="justify-center font-sans font-medium mb-2 text-lg text-center text-primary-dark md:pr-10">
                    ...
                    button; you can change the colors, fonts, styling, and
                    everything you need.
                  </p>
          ...
          <section className="py-10 lg:py-20">
            ...
            <div className="mx-auto mb-24 -mt-8 w-full text-center md:w-1/2">
              ...
              <h1 className="block antialiased font-sans text-2xl leading-[1.3] mb-2 font-semibold tracking-normal text-[#1A237E]">
                ...
                <span className="antialiased font-sans text-2xl leading-[1.3] bg-clip-text text-transparent bg-gradient-to-tr from-blue-600 to-blue-400 inline-block font-bold tracking-normal">
                  More 30 Companies and Organizations around Somaliland and
                  Somalia
                </span>
              </h1>
            </div>
            <div class="flex flex-wrap lg:flex-nowrap items-center justify-center gap-y-2 md:flex md:flex-wrap sm:flex sm:flex-wrap sm:justify-items-center sm:space-y-2">
              <div class="font-semibold text-center rounded-3xl shadow-sm p-10 max-w-xs">
                <img
                  src={Me}
                  className="mb-3 w-32 h-32 mt-2 rounded-full shadow-lg mx-auto"
                  alt=""
                />
                ...
                <div className="mt-8">
                  <a href="https://www.facebook.com/sxabo">
                    <i
                      className="text-light-blue-400 font-lg text-2xl  align-center mr-2 inline-block items-center justify-center 
            ...
            <div className="container mx-auto px-24 -mb-64 -mt-8 rounded-lg  ">
              <div className="flex flex-wrap justify-center text-center ">
                <div className="w-full lg:w-6/12 px-4">
                  <h1 className="text-4xl font-semibold mt-12">Our Team</h1>
                </div>
                <div className="flex flex-wrap mt-24 ">
                  <div className="w-full md:w-6/12 lg:w-3/12 lg:mb-12 -mb-24 px-4 ">
                    ...
                    <div className="pt-6 text-center">
                      <h5 className="text-xl font-bold">Mohamed Dahir</h5>
